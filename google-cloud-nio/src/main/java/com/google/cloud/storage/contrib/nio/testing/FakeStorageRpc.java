...
class FakeStorageRpc extends StorageRpcTestBase {
  ...
  @Override
  public StorageObject moveObject(String bucket, String sourceObject, String destinationObject, Map<StorageRpc.Option,?> sourceOptions, Map<StorageRpc.Option,?> targetOptions) throws StorageException {
    // This logic doesn't exactly match the semantics of the Objects: move API. But it should be close enough for the test.
